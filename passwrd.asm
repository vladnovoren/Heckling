...
greeting_str db "Hello, enter password (6 characters maximum).", 0dh, 0ah, '$'

permission_denied_str db "Wrong password, permission denied.", 0dh, '$'
accessed_str db "Accessed.", 0dh, '$'
